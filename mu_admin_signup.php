...
if(isset($_POST["submit"])) {
    ...
    $duplicate = mysqli_query($conn, "SELECT * FROM mu_ad WHERE username = '$username' OR email = '$email'");
    ...
    if(mysqli_num_rows($duplicate) > 0) {
        ...
        if($password == $confirm_password) {
            ...
            $query = "INSERT INTO mu_ad (spv_name, district_name, state_name, manufacturing_unit, admin_name, designation, email, contact_number, username, password) VALUES ('$spv_name', '$district_name', '$state_name', '$manufacturing_unit', '$admin_name', '$designation', '$email', '$contact_number', '$username', '$password')";
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6 container-box">
                <h2 class="text-center mb-4">MU Administrator</h2>
                <form method="post" action="">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="spv_name" name="spv_name" required>
                            ...
                            <!-- PHP code to fetch and display list of MFPs -->
                            <?php
                            // Example array of MFPs (Replace with actual data fetching logic)
                            $mfp_list = array("MFP1", "MFP2", "MFP3");
                            foreach ($mfp_list as $mfp) {
                                echo "<option value='$mfp'>$mfp</option>";
                            }
                            ?>
                        </select>
                    </div>
              ...
              <option value="Tamil Nadu">Tamil Nadu</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="manufacturing_unit" name="manufacturing_unit" required>
                            ...
                            <!-- Manufacturing units will be populated dynamically based on the selected MFP using JavaScript or AJAX -->
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="username">User Name (FoodparkName_MFP):</label>
