...
<head>
    ...
    <title>MU RETAILER Dashboard</title>
    <!-- Bootstrap CSS -->
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand navbar-heading" href="#">MU RETAILER Dashboard</a>
    </nav>
                ...
                <div class="card no-border">
                    <div class="card-body">
                        <h4 class="card-title">Add details</h4>
                            ...
                            <div class="form-group">
                                <label for="salary">Current profit (Rs):</label>
                                <input type="text" class="form-control" id="current profit">
                            </div>
                            <div class="form-group">
