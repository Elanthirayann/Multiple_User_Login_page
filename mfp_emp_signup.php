...
if(isset($_POST["submit"])) {
    ...
    $duplicate = mysqli_query($conn, "SELECT * FROM mfp_emps WHERE username = '$username' OR email = '$email'");
    
    if(mysqli_num_rows($duplicate) > 0) {
        echo "<script>alert('Username or email is already taken');</script>";
    } else {
        if($password == $confirm_password) {
            $query = "INSERT INTO mfp_emps (spv_name, district_name, state_name, emp_name,department,designation,DOJ,email, contact_number, username, password) VALUES ('$spv_name', '$district_name', '$state_name', '$emp_name','$department','$designation','$DOJ', '$email', '$contact_number', '$username', '$password')";
  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-6 container-box">
        <h2 class="text-center mb-4">MFP Employee Signup</h2>
        <form method="post" action="">
          ...
          <!-- Automatically populated dropdown for State -->
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="email">DOJ in this MFP:</label>
