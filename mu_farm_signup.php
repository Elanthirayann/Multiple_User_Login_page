...
if(isset($_POST["submit"])) {
    ...
    $duplicate = mysqli_query($conn, "SELECT * FROM mu_farm WHERE username = '$username' OR email = '$email'");
    
    if(mysqli_num_rows($duplicate) > 0) {
        echo "<script>alert('Username or email is already taken');</script>";
    } else {
        if($password == $confirm_password) {
             $query = "INSERT INTO mu_farm (spv_name, district_name, state_name, manufacturing_unit, employee_name, department_name, designation, DOJ, email, contact_number, username, password) VALUES ('$spv_name', '$district_name', '$state_name', '$manufacturing_unit', '$employee_name', '$department_name', '$designation', '$DOJ', '$email', '$contact_number', '$username', '$password')";
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6 container-box">
                <h2 class="text-center mb-4">MU Framer Signup</h2>
