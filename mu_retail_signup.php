...
if(isset($_POST["submit"])) {
    ...
    $duplicate = mysqli_query($conn, "SELECT * FROM mu_ret WHERE username = '$username' OR email = '$email'");
    ...
    if(mysqli_num_rows($duplicate) > 0) {
        ...
        if($password == $confirm_password) {
            // Insert new record
            $query = "INSERT INTO mu_ret (spv_name, district_name, state_name, manufacturing_unit, retailer_name, products, location, DOJ, email, contact_number, username, password) VALUES ('$spv_name', '$district_name', '$state_name', '$manufacturing_unit', '$retailer_name', '$products', '$location', '$DOJ', '$email', '$contact_number', '$username', '$password')";
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6 container-box">
                <h2 class="text-center mb-4">MU Retailer Signup</h2>
              ...
              <option value="Tamil Nadu">Tamil Nadu</option>
                    ...
                    <div class="form-group">
                        <label for="products">Products of this MU:</label>
                    ...
                    <div class="form-group">
                        <label for="doj">DOJ with this MU:</label>
