...
<head>
    ...
    <title>MU FARMER Dashboard</title>
    <!-- Bootstrap CSS -->
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand navbar-heading" href="#">MU FARMER Dashboard</a>
    </nav>
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="form-group">
                                <label for="employeeName">Farmer Name:</label>
                            ...
                            <div class="form-group">
                                <label for="salary">Crops grown:</label>
                                <input type="text" class="form-control" id="crops">
                            </div>
                            <div class="form-group">
